...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    fputcsv($out, ['Actividad', 'Nombre usuario', 'Tiempo total (hh:mm:ss)', 'Tiempo en días']);
        ...
        <div class="ms-lg-auto d-flex flex-wrap align-items-center gap-2">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
              <li><a class="dropdown-item" href="<?php echo $csvUrl; ?>"><i class="bi bi-filetype-csv me-2"></i>CSV</a></li>
            </ul>
          </div>
...
?>
<?php if ($reportHasDonutData): ?>
<script type="application/json" id="report-chart-donut-data"><?php echo json_encode($chartDonut, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?></script>
<?php endif; ?>
<?php if ($reportHasBarData): ?>
<script type="application/json" id="report-chart-bar-data"><?php echo json_encode($chartBars, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?></script>
<?php endif; ?>
...
(function(){
  ...
  if(elD && dJson){
    try{
      ...
      var total = vals.reduce(function(a,b){return a+Number(b);},0)||1;
        ...
        options:{
          ...
          scales:{
            x:{
              ...
              ticks:{
                maxTicksLimit:6,
                callback:function(v){ return hmsFromSeg(v); }
              }
            },
          ...
          plugins:{
            ...
            tooltip:{
              callbacks:{
                label:function(ctx){ return ' '+hmsFromSeg(ctx.raw); }
              }
            }
          }
        }
